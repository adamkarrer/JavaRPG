...
public class Sword extends Item {
	...
	public Sword(String name, int worth, int modStat1)
	{
	...
	public void Equip()
	{
		if (has) //If they have it
		{
			if (!equipped) //and it's not equipped
			{
				...
				Game.mainChar.changeDamage(modStat1); //and change stats.
			}
	...
	public void Unequip()
	{
			if (equipped) //if it's equipped
			{
				...
				Game.mainChar.changeDamage(-modStat1); //and change stats back.
			}
